...
% Este documento es un prototipo de libro en komascript, preparado para
% trabajar en español
...
\usepackage[colorlinks=false, pdfborder={0 0 0}, pdftitle=Prototipo, pdfsubject=asunto,pdfauthor=Miguel de Luis, pdflang=es ES, pdfkeywords=palabras clave]{hyperref} %enlaces debe ir al final
...
\date{13 de Junio de 2016} % o la fecha que sea o \today
